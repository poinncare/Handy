...
#[tauri::command]
#[specta::specta]
pub fn change_lowercase_first_letter_setting(app: AppHandle, enabled: bool) -> Result<(), String> {
    let mut settings = settings::get_settings(&app);
    settings.lowercase_first_letter = enabled;
    settings::write_settings(&app, settings);
    Ok(())
}
...
#[tauri::command]
#[specta::specta]
pub fn change_remove_filler_sounds_setting(app: AppHandle, enabled: bool) -> Result<(), String> {
    let mut settings = settings::get_settings(&app);
    settings.remove_filler_sounds = enabled;
    settings::write_settings(&app, settings);
    Ok(())
}
